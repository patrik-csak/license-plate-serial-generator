...
import newHampshire from './states/new-hampshire'
import newJersey from './states/new-jersey'
import newMexico from './states/new-mexico'
import newYork from './states/new-york'
import northCarolina from './states/north-carolina'
import northDakota from './states/north-dakota'
...
import rhodeIsland from './states/rhode-island'
import southCarolina from './states/south-carolina'
import southDakota from './states/south-dakota'
...
class Lpsg {
    ...
    public static idaho = idaho
    public static id = idaho

    public static illinois = illinois
    public static il = illinois

    public static indiana = indiana
    public static in = indiana

    public static iowa = iowa
    public static ia = iowa

    public static kansas = kansas
    public static ks = kansas

    public static kentucky = kentucky
    public static ky = kentucky

    public static louisiana = louisiana
    public static la = louisiana

    public static maine = maine
    public static me = maine

    public static maryland = maryland
    public static md = maryland

    public static massachusetts = massachusetts
    public static ma = massachusetts

    public static michigan = michigan
    public static mi = michigan

    public static minnesota = minnesota
    public static mn = minnesota

    public static mississippi = mississippi
    public static ms = mississippi

    public static missouri = missouri
    public static mo = missouri
    ...
    public static nevada = nevada
    public static nv = nevada

    public static newHampshire = newHampshire
    public static nh = newHampshire

    public static newJersey = newJersey
    public static nj = newJersey

    public static newMexico = newMexico
    public static nm = newMexico

    public static newYork = newYork
    public static ny = newYork

    public static northCarolina = northCarolina
    public static nc = northCarolina

    public static northDakota = northDakota
    public static nd = northDakota

    public static ohio = ohio
    public static oh = ohio

    public static oklahoma = oklahoma
    public static ok = oklahoma
    ...
    public static rhodeIsland = rhodeIsland
    public static ri = rhodeIsland

    public static southCarolina = southCarolina
    public static sc = southCarolina

    public static southDakota = southDakota
    public static sd = southDakota

    public static tennessee = tennessee
    public static tn = tennessee

    public static texas = texas
    public static tx = texas
    ...
    public static virginia = virginia
    public static va = virginia

    public static washington = washington
    public static wa = washington

    public static westVirginia = westVirginia
    public static wv = westVirginia
}
